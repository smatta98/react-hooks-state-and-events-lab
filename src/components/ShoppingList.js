...
let filteredItems = items.filter(item => console.log(item))
...
// Use the useState hook to create a state variable called selectedCategory for keeping track of the selected value from this <select> element. 
